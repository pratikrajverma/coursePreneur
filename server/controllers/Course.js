...
const createCourse = async(req,res)=>{
    try{
        ...
        //validation
        if(!courseDescription || !courseName || !price || 
            // !tag || !thumbnail ||
        ...
        await Category.findByIdAndUpdate(  category  ,  {$push: {course: newCourse._id}},  {new:true}).populate()
...
module.exports = {createCourse, editCourse, showAllCourse, getCourseDetails, getFullDetailsOfCourse, getInstructorCourses, deleteCourse};
