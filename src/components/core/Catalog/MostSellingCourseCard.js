    ...
    return (
        <div className='flex   justify-center  '>
            <Link to={`/courses/${course?._id} `}>
                <div className='box-border relative  hover:border-b-4  hover:border-b-yellow-200 border border-richblue-300 rounded-md transition-colors duration-200 lg:min-h-[25rem] aspect-square p-3'>
